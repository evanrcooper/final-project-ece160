...
#colors = [input("color 1: "), input("color 2: "), input("color 3: "), input("color 4: ")]
colors = ["red", "white", "blue", "white", "green", "white", "yellow", "white", "red", "white", "blue", "white", "green", "white", "yellow", "white"] 
color = "darkgray"
...
while (l < 16):
	...
	pts.append(h/2)
	while (j <= num/16):
		pts.append(rr*math.cos(i)) #x
		pts.append(rr*math.sin(i)) #y
		i += increment
		j += 1
	self.canvas.create_polygon(pts, fill=colors[k])
	k += 1
	j = 0
	l += 1
	pts = []
